  ...
  switch (industry?.toLowerCase()) {
    case "healthcare":
      return {
        ...
        closingThought:
          "The real opportunity is in operationalizing this data, not just reporting on it. Organizations that treat transparency data as a strategic asset (not just a compliance checkbox) are the ones improving margins.",
      };
    ...
    case "legal":
      return {
        ...
        intro:
          "I wanted to share a pattern I'm seeing in legal AI adoption that runs counter to what most people expect.",
        insights: [
          "Firms under 50 attorneys are implementing AI 3x faster than AmLaw 100 firms on average",
          "The advantage isn't resources. It's decision-making speed and willingness to experiment",
    ...
    case "manufacturing":
      return {
        ...
        intro:
          "I've been looking at sales pipeline data from manufacturing companies and noticed some patterns that might be useful for your team.",
        insights: [
          "Deals with engineering involvement before the proposal stage close 40% faster",
          "The biggest predictor of deal size isn't company revenue. It's the number of stakeholders engaged early",
    ...
    default:
      return {
        ...
        intro:
          `I was thinking about your assessment results and wanted to share a framework that might be useful for ${companyName}.`,
        insights: [
