...
function getCategoryInsight(category: string, _score: number): CategoryInsight {
  ...
  if (categoryLower.includes("data quality") || categoryLower === "data quality") {
    return {
      ...
      recommendation:
        "The good news: data quality improvements often deliver ROI within months, not years. A focused data enrichment and validation strategy can transform your foundation without disrupting daily operations.",
    };
  }
  ...
  if (
    ...
    return {
      ...
      recommendation:
        "Modern data cataloging and search solutions can dramatically reduce this friction. The key is making your existing data discoverable without requiring a complete infrastructure overhaul.",
    };
  }
  ...
  if (
    ...
    return {
      ...
      recommendation:
        "Before investing heavily in AI tools, addressing these foundation gaps will dramatically improve your success rate and reduce costly false starts.",
    };
  }
  ...
  return {
    ...
    recommendation:
      "A targeted approach focusing on quick wins in this area can build momentum and demonstrate value before tackling larger initiatives.",
  };
}
