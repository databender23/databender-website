...
export const industries: IndustryWithCta[] = [
  ...
  // 1. Healthcare: 9.25 avg (ChatGPT 9/10, Claude 9.5/10)
  {
    slug: "healthcare",
    title: "Healthcare",
    description: "Protocol lookups in 30 seconds instead of 15 minutes. Your documents become a searchable knowledge base. New hires tap into decades of expertise from day one. Nothing leaves your building.",
    icon: "heart",
  ...
  // 2. Construction: 8.0 (ChatGPT 8/10, Claude not scored)
  {
    slug: "construction",
    title: "Construction",
    description: "See every job's margin in real time, not at closeout. Change orders tracked from field approval to billing. One view across Procore, Sage, and your field apps. No more spreadsheet archaeology.",
    icon: "hardhat",
    lottie: "/animations/construction-industry.json",
    ctaText: "See Where You Stand",
    ctaHref: "/assessments/construction",
    ctaSubtext: "5-minute readiness assessment",
  },
  // 3. Manufacturing: 7.75 avg (ChatGPT 9/10, Claude 6.5/10)
  {
    slug: "manufacturing",
    title: "Manufacturing",
    description: "Support 20% more volume without adding headcount. Orders, production, and shipments in one place. Spec lookups in seconds. AI that runs on your equipment, so your competitive data stays private.",
    icon: "factory",
  ...
  // 4. Wholesale Distribution: 6.75 avg (ChatGPT 8/10, Claude 5.5/10)
  {
    ...
    description: "Know which customers actually make you money. See what moves and what doesn't. Free up cash tied in dead stock. One view across ERP, WMS, and sales data that shows you where the margin goes.",
    icon: "truck",
  ...
  // 5. Commercial Real Estate: 5.0 avg (ChatGPT 6/10, Claude 4/10)
  {
    ...
    description: "Find the real owner behind the LLCs (95%+ accuracy). Review a data room overnight. See occupancy, NOI, and lease expirations across every property in one place, even when they all use different software.",
    icon: "building",
  ...
  // 6. Legal: 4.75 avg (ChatGPT 5/10, Claude 4.5/10)
  {
    slug: "legal",
    title: "Legal",
    description: "Associates bill more hours. Partners keep their knowledge in the firm. Pitches win 31% more often. AI that stays on your servers, so your ethics committee says yes.",
    icon: "scale",
    ctaText: "Get the Free Guides",
    ctaHref: "/industries/legal#guides",
    ctaSubtext: "Practical playbooks for firms ready to move",
  },
];
...
export const industryContent: Record<string, {
  ...
  "commercial-real-estate": {
    ...
    useCases: [
      ...
      { title: "Portfolio Application", description: "20 properties on 3 different systems. One view of occupancy, NOI, collections, and loan maturities. No more logging into four places to answer one question." },
  ...
  "construction": {
    ...
    solutions: [
      { title: "One View of Every Job", description: "We connect Procore, your accounting system (Sage, QuickBooks, Vista), and field apps into one application. Answer 'How's this job doing?' in 30 seconds." },
      ...
      { title: "Post-Acquisition Integration", description: "One application across acquired companies in weeks. No waiting 18 months for system migration." },
    ],
    benefits: [
      ...
      { title: "Live in Weeks, Not Years", description: "First applications in 4-6 weeks. Prove value before the big commitment." },
    ...
    useCases: [
      ...
      { title: "Board and Investor Reporting", description: "Portfolio applications that generate automatically. No fire drill before board meetings." },
  ...
  "wholesale-distribution": {
    ...
    useCases: [
      ...
      { title: "Customer Profitability Application", description: "Your 'top 10 customers' ranked by actual margin, not revenue. Some surprises guaranteed." },
      ...
      { title: "Post-Acquisition Consolidation", description: "Three ERPs from three acquisitions? One unified application showing inventory, customers, and margin across all." },
