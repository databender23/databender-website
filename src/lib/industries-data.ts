...
export const industries: IndustryWithCta[] = [
  ...
  },
  {
    ...
    description: "AI that actually closes deals. We resolved 1.69M ownership records at 125x less cost than manual review—so you know exactly who to call and can process data rooms in hours, not weeks.",
    icon: "building",
...
export const industryContent: Record<string, {
  ...
  "legal": {
    challenges: [
      ...
      "Every AI tool wants your client data in the cloud—an ethics headache you can't afford",
    ],
    solutions: [
  ...
  "commercial-real-estate": {
    ...
    useCases: [
      ...
      { title: "Off-Market Deal Sourcing", description: "Find owners before they list. See who's held properties for 10+ years, who's paying high taxes, who might be motivated—with clean data you can trust." },
  ...
  "manufacturing": {
    challenges: [
      ...
      "Decades of product specs, procedures, and tribal knowledge exist somewhere—in binders, shared drives, retired engineers' heads. Nobody can find anything.",
    ...
    useCases: [
      ...
      { title: "Complete Customer View", description: "Rep opens Salesforce, sees order history, shipment status, quality issues, payment patterns, reorder predictions—without asking anyone or switching systems." },
