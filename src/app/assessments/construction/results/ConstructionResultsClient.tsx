...
function getStoredResults(): ResultsData | null {
  ...
  const stored = sessionStorage.getItem("constructionAssessmentResults");
  if (!stored) {
    cachedResults = null;
    cachedRaw = null;
    return null;
...
export default function ConstructionResultsClient() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Button href="/assessments/construction">Take Assessment</Button>
        </div>
      </div>
    );
  }
  ...
  const categoryLabels = {
    ...
    marginVisibility: "Margin Visibility",
    changeOrders: "Change Order Tracking",
    reporting: "Reporting Efficiency",
    cashFlow: "Cash Flow Visibility",
  };
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            <h1 className="text-3xl md:text-4xl font-bold text-text-primary mb-4">
              Your Construction Data Readiness Results
            </h1>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <h2 className="text-2xl font-bold text-text-primary mb-2">
                  {contactInfo.company}&apos;s Readiness Score
                </h2>
