...
export default function DistributionClient() {
  ...
  const currentQuestion = distributionQuestions[currentStep];
  const isLastQuestion = currentStep === distributionQuestions.length - 1;
  ...
  const handleAnswer = (value: number) => {
    ...
    setTimeout(() => {
      if (isLastQuestion) {
        setCurrentStep(distributionQuestions.length);
      } else {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const scores = calculateDistributionScores(answers);

    try {
      // Store results in sessionStorage for results page
      sessionStorage.setItem(
        "distributionAssessmentResults",
      ...
      router.push("/assessments/distribution/results");
    } catch (error) {
        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-text-primary mb-4">
              Distribution Analytics Assessment
            </h1>
            <p className="text-text-secondary">
              See where you&apos;re leaving margin on the table and cash tied up in inventory
            </p>
          </motion.div>
                ...
                <div className="mb-8">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-teal-500 text-sm font-medium">
                      Question {currentStep + 1} of {distributionQuestions.length}
                    </span>
              ...
              >
                <div className="mb-8">
                  ...
                  <p className="text-text-secondary mt-2">
                    ...
                    recommendations for your distribution operation.
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <Input
                    ...
                    onChange={handleContactChange}
                    placeholder="e.g., CEO, CFO, VP Sales, VP Operations"
                  />
                  <div>
