...
const assessments: Assessment[] = [
  ...
  },
  {
    ...
    description: "Evaluate your document management, knowledge retention, and AI readiness. Get a strategic roadmap for AI adoption.",
    time: "5 minutes",
    href: "/assessments/healthcare-ai-readiness",
    industry: "healthcare",
    icon: "brain",
  },
  {
