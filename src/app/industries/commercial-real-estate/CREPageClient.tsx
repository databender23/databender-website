...
import { creGuides } from "@/lib/lead-magnets-data";
  ...
  return (
    <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                    ...
                    {[
                      {
                        ...
                        description: "Which properties you're targeting and why. Your competitors will never know."
                      },
                      {
                        title: "Your scoring models",
                        description: "The criteria that identify your best opportunities stay proprietary."
                      },
                      {
                        title: "Owner contact lists",
                        description: "The verified decision-makers you've identified remain your advantage."
                      },
                      {
                        title: "Due diligence findings",
                        description: "Your analysis and deal assessments never leave your systems."
                      },
                    ].map((item, index) => (
                      <li key={index} className="flex items-start gap-2 sm:gap-3">
                        <svg
              ...
              <div className="order-1 lg:order-2">
                ...
                <motion.h2
                  ...
                  className="text-2xl sm:text-3xl md:text-4xl font-bold text-text-primary mb-4 sm:mb-6"
                >
                  Your Pipeline Stays on Your Servers
                </motion.h2>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                  <p>
                    Your deal pipeline is competitive intelligence. Which properties
                    you&apos;re targeting, which owners you&apos;ve identified, how you
                    score opportunities—that&apos;s valuable information you don&apos;t
                    want going to a third party.
                  </p>
                  <p>
                    Everything runs on your own systems. No sensitive data goes
                    to external AI services. Your pipeline stays yours.
                  </p>
                  <p className="font-medium text-text-primary">
      ...
      <section id="guides" className="section scroll-mt-24">
        <div className="container mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-16">
            ...
            >
              Practical insights for finding owners, speeding due diligence, and prioritizing deals. No fluff, just strategies that work.
            </motion.p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {creGuides.map((guide, index) => (
              <motion.div
                key={guide.slug}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
      ...
      <CTA
        ...
        description="Schedule a consultation to discuss your specific challenges, or see how we fixed 1.69 million broken ownership records for a CRE client."
