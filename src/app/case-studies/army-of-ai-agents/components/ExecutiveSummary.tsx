            ...
            <div className="px-6 pb-6 space-y-6">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="bg-bg-primary/50 rounded-xl p-4 border border-border">
                  ...
                  <p className="text-sm text-text-secondary leading-relaxed">
                    <span className="font-semibold text-text-primary">1.69 million owner records</span> with broken IDs. 44,421 groups where different people shared the same ID. One ID had 670 people assigned to it.
                  </p>
                </div>
                ...
                <div className="bg-bg-primary/50 rounded-xl p-4 border border-border">
                  ...
                  <p className="text-sm text-text-secondary leading-relaxed">
                    A <span className="font-semibold text-text-primary">five-step pipeline</span> that separates records that shouldn&apos;t share an ID, consolidates records that should, and validates every decision with AI agents.
                  </p>
                </div>
                ...
                <div className="bg-bg-primary/50 rounded-xl p-4 border border-border">
                  ...
                  <p className="text-sm text-text-secondary leading-relaxed">
                    <span className="font-semibold text-text-primary">1.25 million unique owners</span> identified. More accurate offers, better ownership tracking, and first-mover advantage on deals. Competitors still use the broken data.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-center gap-6 pt-4 border-t border-border">
                <div className="text-center">
                  <p className="text-2xl font-bold text-teal-500">1.69M</p>
                  <p className="text-xs text-text-muted">Records Processed</p>
                </div>
                <div className="w-px h-8 bg-border" />
                <div className="text-center">
                  <p className="text-2xl font-bold text-text-primary">1.25M</p>
