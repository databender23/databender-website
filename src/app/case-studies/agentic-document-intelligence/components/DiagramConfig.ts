...
export const industryCards = [
  {
    industry: 'Healthcare',
    challenge: 'Medical Catalogs & Documentation',
    description: 'Instead of manually entering 200 items from a surgical kit catalog, our AI reads the entire document and extracts every item, code, and description automatically.',
    metric: '2 hours per catalog to 5 minutes',
    isCta: false,
  },
  {
    industry: 'Legal',
    challenge: 'Contract Analysis',
    description: 'Contract reviews that took 3 days now take 2 hours. Every clause, obligation, and risk is extracted and categorized - ready for your legal team to review.',
    metric: 'From 3 days to 2 hours',
    isCta: false,
  },
  {
    industry: 'Insurance',
    challenge: 'Claims Processing',
    description: 'Supporting documents for claims are automatically parsed. Policy numbers, dates, amounts, and key facts flow directly into your claims system.',
  ...
  },
  {
    ...
    description: 'Loan applications, KYC documents, and regulatory filings are processed with full audit trails. Every extraction is logged for compliance.',
  ...
  },
  {
    ...
    description: 'Product specs from suppliers are automatically converted to structured data. Part numbers, materials, dimensions - all captured and ready for your PLM system.',
    metric: 'Unified product database',
    isCta: false,
  },
  {
    industry: 'Your Industry',
    challenge: 'Custom Document Workflows',
    description: 'Any document type that requires understanding structure, context, and relationships - we build an AI team specifically for your documents.',
