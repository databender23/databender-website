...
// Sample customer records that show the messy reality of data
const sampleRecords = [
  // Cluster 1 - Same person, different representations
  { id: 1, name: 'John Smith', address: '123 Main St, NYC', phone: '555-1234', email: 'john.smith@email.com', cluster: 1 },
  { id: 2, name: 'J. Smith', address: '123 Main Street, New York', phone: '(555) 123-4', email: 'jsmith@work.com', cluster: 1 },
  { id: 3, name: 'Jonathan Smith', address: '123 Main St Apt 2B', phone: '555.1234', email: 'jonsmith@gmail.com', cluster: 1 },

  // Cluster 2 - Another person
  { id: 4, name: 'Sarah Johnson', address: '456 Oak Ave', phone: '555-5678', email: 'sarah.j@company.com', cluster: 2 },
  { id: 5, name: 'S. Johnson', address: '456 Oak Avenue', phone: '555-5678', email: 'sjohnson@email.com', cluster: 2 },

  // Cluster 3 - Third person
  { id: 6, name: 'Michael Brown', address: '789 Pine Rd', phone: '555-9012', email: 'mbrown@work.org', cluster: 3 },
  { id: 7, name: 'Mike Brown', address: '789 Pine Road', phone: '(555) 901-2', email: 'mike.brown@email.com', cluster: 3 },
  { id: 8, name: 'M. Brown', address: '789 Pine Rd #5', phone: '555 9012', email: 'mikeb@home.net', cluster: 3 },

  // Cluster 4
  { id: 9, name: 'Emily Davis', address: '321 Elm St', phone: '555-3456', email: 'emily.d@mail.com', cluster: 4 },
  { id: 10, name: 'E. Davis', address: '321 Elm Street', phone: '555-345-6', email: 'edavis@company.com', cluster: 4 },

  // Cluster 5
  { id: 11, name: 'Robert Wilson', address: '654 Maple Dr', phone: '555-7890', email: 'rwilson@work.com', cluster: 5 },
  { id: 12, name: 'Rob Wilson', address: '654 Maple Drive', phone: '(555) 789-0', email: 'bob.wilson@email.com', cluster: 5 },
]
...
export default function CustomerRecordCards({
  ...
  const highlightedIds = [1, 2, 3] // John Smith variations
  ...
  return (
    ...
    >
      ...
      {showLabels && organizationLevel > 0.7 && (
        ...
        >
          {[
            { label: 'John Smith', x: '20%', y: '8%' },
            { label: 'Sarah Johnson', x: '80%', y: '8%' },
            { label: 'Michael Brown', x: '50%', y: '35%' },
            { label: 'Emily Davis', x: '20%', y: '60%' },
            { label: 'Robert Wilson', x: '80%', y: '60%' },
          ].map((cluster, i) => (
            <div
              key={i}
