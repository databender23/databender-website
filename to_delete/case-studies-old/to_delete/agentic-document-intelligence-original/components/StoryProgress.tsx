...
const acts = [
  { id: 1, label: 'Problem', anchor: 'act1' },
  { id: 2, label: 'Stakes', anchor: 'act2' },
  { id: 3, label: 'Approach', anchor: 'act3' },
  { id: 4, label: 'Solution', anchor: 'act4' },
  { id: 5, label: 'Results', anchor: 'act5' },
]
